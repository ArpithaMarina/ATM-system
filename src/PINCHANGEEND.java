 ...
 * @author josep
 */
public class PINCHANGEEND extends javax.swing.JFrame {

    /**
     * Creates new form PINCHANGEEND
     */
    public PINCHANGEEND() {
        initComponents();
    }
public PINCHANGEEND(String us){
        initComponents();
         user.setText(us);
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pops.jpg"))); // NOI18N
        jPanel4.add(jLabel4);
        jLabel4.setBounds(250, 10, 570, 140);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 3, 44)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(204, 255, 204));
        jLabel1.setText("New PIN for your Account has  been set Successfully.");
        jPanel4.add(jLabel1);
        jLabel1.setBounds(60, 400, 990, 100);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tenor.gif"))); // NOI18N
        jPanel4.add(jLabel2);
        jLabel2.setBounds(460, 240, 220, 160);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PINCHANGEEND.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PINCHANGEEND().setVisible(true);
            }
        });
    }
